...
export declare type ThemeComponentSizeType<Component extends keyof ITheme['components']> = 'sizes' extends keyof ITheme['components'][Component] ? keyof ITheme['components'][Component]['sizes'] | (string & {}) : never;
